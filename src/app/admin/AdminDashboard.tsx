  ...
  return (
    <div className="flex flex-col gap-10">
      ...
      <div className="grid grid-cols-1 gap-6">
        {filtered.map((app) => (
          <div key={app.id} className="glass p-8 rounded-[2.5rem] border-white/10 group hover:border-primary/30 transition-all flex flex-col lg:flex-row gap-10 lg:items-center">
            <div className="flex-grow flex flex-col gap-6">
              <div className="flex items-center gap-6">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-x-6 gap-y-2 text-sm">
                    <a href={`mailto:${app.email}`} className="text-primary hover:underline flex items-center gap-2">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="bg-white/5 p-4 rounded-2xl border border-white/5 flex items-center gap-4">
                  ...
                  <div>
                    <span className="text-xs text-slate-400 uppercase font-bold tracking-widest block">Date</span>
                ...
                <div className="bg-white/5 p-4 rounded-2xl border border-white/5 flex items-center gap-4">
                  ...
                  <div>
                    <span className="text-xs text-slate-400 uppercase font-bold tracking-widest block">Time</span>
            ...
            <div className="lg:w-64 flex flex-col gap-4">
              <div className="flex flex-col gap-2">
                ...
                <div className={`text-center py-2 rounded-xl font-bold border ${
